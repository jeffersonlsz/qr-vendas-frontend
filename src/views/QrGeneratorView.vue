...
const dropdownItems = ref([
  {
    label: 'Parceiro',
    description: 'Cadastrar um parceiro individual.',
    icon: '👤',
    action: () => handleAddPartner()
  },
  {
    label: 'Lote de cartões',
    description: 'Gerar vários cartões para distribuição.',
    icon: '📦',
    action: () => handleOpenBulkModal()
  },
  {
    label: 'Operador',
    description: 'Adicionar um novo operador do sistema.',
    icon: '👥',
    action: () => modalOperadorOpen.value = true
  }
]);
// Métodos
